...
exports.OsTimelineController = OsTimelineController;
function osTimelineDirective() {
    return {
        scope: {
        ...
        compile: function (tElement) {
            ...
            return function (scope, iElement, iAttrs, MsTimelineCtrl) {
...
exports.osTimelineDirective = osTimelineDirective;
/** @ngInject */
function osTimelineItemDirective($timeout, $q) {
    return {
        scope: true,
        require: '^osTimeline',
        compile: function (tElement) {
            ...
            return function (scope, iElement, iAttrs, MsTimelineCtrl) {
                var threshold = 72, itemLoaded = false, itemInViewport = false, scrollEl = MsTimelineCtrl.getScrollEl();
                //////////
                init();
                /**
                 * Initialize
                ...
                function init() {
                    ...
                    if (iElement.find('os-card')) {
                        ...
                        scope.$on('osCard::cardTemplateLoaded', function (event, args) {
                ...
                // Item ready watcher
                var itemReadyWatcher = scope.$watch(function () { return (itemLoaded && itemInViewport); }, function (current, old) {
                ...
                function testForImage(element) {
                    var deferred = $q.defer(), imgEl = element.find('img');
                    if (imgEl.length > 0) {
...
exports.osTimelineItemDirective = osTimelineItemDirective;
